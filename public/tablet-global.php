...
<body>
    ...
    <script>
        ...
        // own top-level Firestore reads, which can hang while offline. Placed
        // here (after the elements above it) rather than earlier in <body>
        // so document.getElementById calls below don't run before the DOM
        // exists yet — this script still runs immediately, well before the
        // module's blocking import resolves.
...
<script type="module">
    ...
    // window because the offline-overlay script (deliberately outside this
    ...
    // The offline-overlay script's earlier calls (page load, before this
